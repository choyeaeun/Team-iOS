...
class HomeDetailViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "HomeDetailTableViewCell") as! HomeDetailTableViewCell
    ...
    @IBAction func expertMorePressed(_ sender: Any) {
        ...
        guard let moreExpertVC = UIStoryboard(name: "Sub", bundle: nil).instantiateViewController(withIdentifier: "MoreExpertViewController") as? MoreExpertViewController else
        { return }
    ...
    @IBAction func applyMorePressed(_ sender: Any) {
        ...
        guard let moreApplyVC = UIStoryboard(name: "Sub", bundle: nil).instantiateViewController(withIdentifier: "MoreApplyViewController") as? MoreApplyViewController else { return }
