...
class FavoriteViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    var expertData3 = Expert(image: #imageLiteral(resourceName: "gray_img"),id: "오목교바오밥나무", type: "쇼핑형", maincity: "베이징", rate: 4.0)
    var expertData4 = Expert(image: #imageLiteral(resourceName: "gray_img"),id: "일산닭칼국수지니", type: "먹부림", maincity: "뉴욕", rate: 4.5)
    var expertData5 = Expert(image: #imageLiteral(resourceName: "gray_img"),id: "몽구사랑섬민", type: "고독한여행가", maincity: "오사카", rate: 2.5)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            cell.cityLabel.text = expertData3.maincity
            }
        else {
